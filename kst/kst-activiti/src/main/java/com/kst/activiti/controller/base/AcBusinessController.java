package com.kst.activiti.controller.base;
...
import com.kst.activiti.controller.util.BpmsActivityTypeEnum;
import com.kst.activiti.controller.util.UtilMisc;
import com.kst.activiti.utils.Const;
import com.kst.activiti.utils.DelFileUtil;
import com.kst.activiti.utils.FileUpload;
...
public class AcBusinessController extends BaseController {
	...
	@Autowired
	private RuntimeService runtimeService; 		//与正在执行的流程实
    // 例和执行对象相关的Service(执行管理，包括启动、推进、删除流程实例等操作)
...
//	 * @param
//	 */
//	protected Object getVariablesByTaskIdAsMap(String taskId){
//		return taskService.
//	}
	/**设置流程变量(不绑定任务)
	 * @param taskId	//任务ID
	...
	protected void setVariablesByTaskId(String taskId,String key,String value){
		...
		System.out.println("****设置流程变量****taskId:"+taskId + "   key:"+key + "   value:"+value);
	}
