...
import com.kst.activiti.base.BaseServiceImpl;
 ...
 * 作者：ys
 * 版本：1.0
 * 日期：2019-7-25 上午10:19:16
 *
 */
public class TaskBaseServiceImpl{
...
//     * @return 节点流向集合
//     */
//    private  List<BpmnModel> clearTransition(BpmnModel activityImpl) {
//        // 存储当前节点所有流向临时变量
//        List<BpmnModel> oriPvmTransitionList = new ArrayList<PvmTransition>();
//        // 获取当前节点所有流向，存储到临时变量，然后清空
//        List<BpmnModel> pvmTransitionList = activityImpl.getProcesses();
//
