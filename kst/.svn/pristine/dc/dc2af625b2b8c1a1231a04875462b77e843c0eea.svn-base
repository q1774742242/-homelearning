...
public class ModelerController {
    ...
    public RestResponse publish(String modelId){
        ...
        try {
            ...
            if (bytes == null) {
                ...
                return RestResponse.failure("部署ID:{}的模型数据为空，请先设计流程并成功保存，再进行发布",modelId);
            }
            ...
            return RestResponse.failure("部署modelId:{}模型服务异常：",modelId);
        }
