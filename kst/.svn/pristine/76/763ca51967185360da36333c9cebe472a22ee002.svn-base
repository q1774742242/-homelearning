...
<div class="panel-body" style="padding-bottom:0px;">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-inline" id="searchForm">
                ...
                <div class="form-group" style="margin-right:20px">
                    <label for="s_tel">手机</label>
                    <input type="text" class="form-control _search" name="search_like_tel">
                </div>
                <div class="form-group" style="margin-right:20px;">
                    <label for="s_disableFlag">状态</label>
                    <select id="s_disableFlag" name="search_eq_disableFlag" class="selectpicker _search" title="请选择" data-width="100px">
    ...
    <div id="toolbar" class="btn-group">
        ...
        <button type="button" id="delBtn" onclick="printQRCode();"class="btn btn-info">
            <span class="glyphicon glyphicon-print" ></span>打印用户
        </button>
    </div>
...
<script>
            ...
            columns: [{
                ...
                formatter : function(value, row, index) {
                    ...
                    if(row.disableFlag==true){
                        ...
                        c = '<span class="label label-default">锁定</span>';
                    }else{
    ...
    function operateFormatter(value, row, index) {//赋予的参数
        return [
            '<a href="#" onclick="dt_update(\''+ row.id + '\')" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" ></span>编辑</a>  ',
