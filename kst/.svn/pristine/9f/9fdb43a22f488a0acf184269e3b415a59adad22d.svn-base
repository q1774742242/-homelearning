    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <form class="form-inline" id="searchForm">
                ...
                <button type="button" style="margin-left:100px" onclick="re_load();" class="btn btn-primary">查询</button>
                <br><br>
                <div class="form-group" style="margin-right:20px">
                    <label>项目状态</label>
                    <#list status as type>
...
<script>
    ...
    function operateFormatter(value, row, index) {//赋予的参数
        return [
            '<a href="javascript:void(0)" onclick="scheduleRegister(\'' + row.id + '\')" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" ></span>选择项目</a>  ',
        ].join('');
    }

    //进入该项目的计划一览
    function scheduleRegister(id) {
        parent.addTabs({
            id: "r"+id,
            title: '进度登记',
            close: true,
            height:800,
            href: '${base}/pjs/scheduleRegister/toRegister/'+id,
            urlType: "relative"
        });
    }
