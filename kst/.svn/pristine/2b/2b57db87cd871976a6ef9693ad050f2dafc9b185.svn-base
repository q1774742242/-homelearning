    ...
    <form class="form-horizontal" id="form">
        ...
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-2 control-label" for="loginName"><@spring.message "sys.organization.parentNode" /></label>
                <div class="col-sm-6" >
                    <input type="text" id="parent" class="form-control" readonly="readonly" value="${organization.parentName}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="nickName"><@spring.message "sys.organization.name" /></label>
