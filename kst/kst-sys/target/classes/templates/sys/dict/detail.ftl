    ...
    <form class="form-horizontal" id="dictForm">
        ...
        <div class="box-body">
            <div class="form-group" style="height: 55px">
                ...
                <div class="col-sm-5">
                    <input type="text" name="type" class="form-control" id="type" <#if dict.lockFlag>readonly</#if> placeholder="请输入TYPE"
                           value="${dict.type}">
                </div>
            </div>
            <div class="form-group" style="height: 55px">
            ...
            <div class="form-group" style="height: 55px">
                ...
                <div class="col-sm-5">
                    <input type="text" name="value" class="form-control" id="value" <#if dict.lockFlag>readonly</#if> placeholder="请输入值"
                           value="${dict.value}">
                </div>
            </div>
            <div class="form-group" style="height: 55px">
                ...
                <div class="col-sm-5">
                    <input type="text" name="sort" class="form-control" id="sort" placeholder="请输入排序值" <#if dict.lockFlag>readonly</#if>
                           value="${dict.sort}">
                </div>
            </div>
            <div class="form-group" style="height: 55px">
                ...
                <div class="col-sm-5">
                    <textarea id="description" name="description" class="form-control" <#if dict.lockFlag>readonly</#if> rows="4">${dict.description}</textarea>
                </div>
            </div>
        </div>
        <!-- /.box-body -->
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.success) {
                            ...
                            if (1 == mode) {
                                toastr.error("保存系统字典出错");
                            } else {
                                toastr.error("修改系统字典出错");
                            }
