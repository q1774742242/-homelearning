...
<div class="box box-info" style="margin-bottom:0px;">
    <select name="search_eq_type_id" id="search_eq_type_id" class="form-control" title="<@spring.message "sys.message.choice" />"
            data-width="100%">
    </select>
</div>
    ...
    function selectFileType(){
        $.ajax({
            ...
            success:function (data) {
                var options="<option value=''><@spring.message "sys.message.choice"/></option>";
