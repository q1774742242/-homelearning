    ...
    <form id="roleForm" class="form-horizontal" >
        ...
        <div class="box-body">
            <div class="form-group" style="height: 55px;">
                <label class="col-md-2 control-label"><@spring.message "sys.role.name" /></label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="name" id="name" value="${role.name}"/>
                </div>
            </div>
            <div class="form-group" style="height: 120px;">
                <label class="col-md-2 control-label"><@spring.message "sys.role.remarks" /></label>
                <div class="col-md-7">
                    <textarea name="remarks" id="remarks" type="text" class="form-control" rows="4"
                              placeholder="<@spring.message "sys.role.remarkMessage" />">${role.remarks}</textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label"><@spring.message "sys.role.roleTree" /></label>
                <div class="col-md-7">
        ...
        $('#roleForm').bootstrapValidator({
            ...
            fields: {
                name: {
                    validators: {
                        notEmpty: {
                            message: '<@spring.message "sys.role.name" /><@spring.message "sys.user.validate.notEmpty" />'
                        },
                        ...
                        remote: {//ajax验证。server result:{"valid",true or false} 向服务发送当前input name值，获得一个json数据。例表示正确：{"valid",true}
                            ...
                            message: '<@spring.message "sys.role.validate.roleNameExist" />',//提示消息
